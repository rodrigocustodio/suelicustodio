          ...
          {showButton && (
            <div className="text-center mt-6 animate-fade-in">
              <button
                ...
                className="inline-block bg-cta-500 hover:bg-cta-600 text-white text-lg font-semibold px-8 py-4 rounded-lg transition-all shadow-lg hover:shadow-xl hover:scale-105 hover:-translate-y-0.5"
              >
